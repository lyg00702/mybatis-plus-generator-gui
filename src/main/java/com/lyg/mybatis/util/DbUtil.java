...
import com.lyg.mybatis.exception.DbDriverLoadingException;
    ...
    public static List<UITableColumnVO> getTableColumns(DatabaseConfig dbConfig, String tableName) throws Exception {
		...
		try {
			...
			while (rs.next()) {
				...
				//2019.10.16 fix mysql8 IS_AUTOINCREMENT issue
...
//                    columnVO.setAutoincrement(rs.getBoolean("IS_AUTOINCREMENT"));
//                }else if("MySQL_8".equals(dbConfig.getDbType())){
//				    if("YES".equals(rs.getString("IS_AUTOINCREMENT"))){
//                        columnVO.setAutoincrement(true);
//                    }else {
//                        columnVO.setAutoincrement(false);
